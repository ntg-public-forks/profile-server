...
export default function CreateTemplateForm({rootUrl, isPublished}) {
        ...
        <div className="usa-layout-docs usa-layout-docs__main usa-prose">
            ...
            >
                {(formikProps) => (<>
                        ...
                        <Form className="usa-form" style={{ maxWidth: "none" }}> {/*style={{maxWidth: 'inherit'}}>*/}
                            <fieldset className="usa-fieldset">
                                <Iri message="This statement template already has an IRI used in xAPI statments"
                                    sublabel={isPublished ? '' : <>The IRI is what you will use to identify this concept in xAPI statements. A portion of the IRI depends on the IRI for the profile.
                    ...
                    <CancelButton className="usa-button usa-button--unstyled" type="reset" cancelAction={() => navigate(rootUrl)} />
                </>)}
            </Formik>
        </div>
    );
